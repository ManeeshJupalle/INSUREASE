    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 flex flex-col items-center justify-center p-8">
      <div className="max-w-2xl w-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
        ...
        <div className="relative mb-6">
          <select
            className="w-full p-4 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 appearance-none focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-600 focus:border-transparent"
          ...
          <FaChevronDown className="absolute right-4 top-5 text-gray-500 dark:text-gray-400" />
        </div>
        ...
        <button
          ...
          className="w-full py-4 bg-gradient-to-r from-blue-300 to-purple-300 dark:from-blue-600 dark:to-purple-600 text-white rounded-xl hover:opacity-90 transition-opacity text-lg font-semibold flex items-center justify-center gap-2"
        >
